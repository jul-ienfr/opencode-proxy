...
MODEL_CAPABILITIES: dict[str, list[str]] = {
    ...
    "mimo-v2.6-pro": ["chat", "tools", "vision"],
    "mimo-v2.6-flash": ["chat", "tools", "vision"],
    "mimo-v2.6-flash-free": ["chat", "vision"],
...
_MODEL_LIMITS_FALLBACK: dict[str, list[int]] = {
    ...
    "mimo-v2.6-pro": [3250, 8150, 16300],
    "mimo-v2.6-flash": [30100, 75200, 150400],
